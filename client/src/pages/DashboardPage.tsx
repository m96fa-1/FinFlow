...
export default function DashboardPage() {
	...
	const metrics = [
		{ title: 'Total Balance', 		amount: '$12,450.80', changeValue: '', 			changeText: 'Across all Accounts', 	changeStatus: 'positive', 	note: 'Active Accounts', 	noteStatus: 'positive', lucideElement: <Landmark strokeWidth={1.75} color='#6a7282' /> },
		{ title: 'Monthly Spending', 	amount: '$4,200.00', 	changeValue: '-$336', changeText: 'vs last month', 	changeStatus: 'negative', 	note: 'Manual & Linked', 	noteStatus: 'negative', lucideElement: <BanknoteArrowDown strokeWidth={1.75} color='#6a7282' /> },
		{ title: 'Budget Used', 			amount: '68%', 				changeValue: '$769', 	changeText: 'remaining', 			changeStatus: 'neutral', 		note: 'Target < 80%', 		noteStatus: 'positive', lucideElement: <ChartPie strokeWidth={1.75} color='#6a7282' /> },
		{ title: 'Savings Rate', 			amount: '19%', 				changeValue: '+3%', 	changeText: 'vs last month', 								changeStatus: 'positive', 	note: 'Goal 25%', 				noteStatus: 'positive', lucideElement: <PiggyBank strokeWidth={1.75} color='#6a7282' /> },
	];
	...
	return (
		<>
			...
			<div className='mt-18 flex'>
				<nav className='w-60'>test</nav>
				<div className='flex-1 p-8 space-y-8 bg-gray-100'>
