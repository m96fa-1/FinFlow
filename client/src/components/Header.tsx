		...
		<header className='px-8 h-22 bg-white'>
			<nav className='h-full flex items-center justify-between'>
				...
				<div className='h-full flex items-center gap-8'>
					<Link to='/support' className='h-full flex items-center text-darkest-text hover:text-bluish-cyan'>Support</Link>
					<Link to='/register' className='h-full flex items-center text-darkest-text hover:text-bluish-cyan'>Get Started</Link>
